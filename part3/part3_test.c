...
int main() {
    ...
    //This creates them and makes them run their respective library functions.
    //They act as libraries trying to allocate memory from themselves using this program.
    //They hit the allocate many times, so most nodes should be taken by the end.
    ...
    pthread_create(&thread2, NULL, threadAllocate, NULL);
    pthread_create(&thread3, NULL, threadAllocate, NULL);
    pthread_create(&thread4, NULL, threadAllocate, NULL);
    pthread_create(&thread5, NULL, threadAllocate, NULL);
    pthread_create(&thread6, NULL, threadAllocate, NULL);
    pthread_create(&thread7, NULL, threadAllocate, NULL);
    pthread_create(&thread8, NULL, threadAllocate, NULL);
    pthread_create(&thread9, NULL, threadDeallocate, memory);
    pthread_create(&thread10, NULL, threadDeallocate, memory);
    pthread_create(&thread11, NULL, threadDeallocate, memory);
    pthread_create(&thread12, NULL, threadDeallocate, memory);
    pthread_create(&thread13, NULL, threadDeallocate, memory);
    pthread_create(&thread14, NULL, threadDeallocate, memory);
